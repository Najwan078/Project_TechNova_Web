      ...
      <div className="flex flex-col lg:flex-row gap-4 mb-6">
        <div className="relative flex-1 flex gap-2">
          ...
          <select
            ...
            className="bg-[#0a0a20] border border-white/[0.08] rounded-xl pl-5 pr-8 py-3 text-xs text-slate-300 focus:outline-none focus:border-cyan-400/50 cursor-pointer flex-shrink-0 min-w-[160px]"
          >
