    ...
    <div style={{ animation: 'fadeInUp 0.6s ease-out' }}>
      <div className="flex flex-col lg:flex-row gap-4 mb-6">
        ...
        <div className="flex gap-2 flex-wrap items-center z-50">
          ...
          >
            {isSortingSemester ? <Spinner color="text-purple-400" /> : <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="group-hover:scale-110 transition-transform"><polygon points="12 2 2 7 12 12 22 7 12 2"/><polyline points="2 17 12 22 22 17"/><polyline points="2 12 12 17 22 12"/></svg>}
          </button>
